...
class LawnmowerTests {
	...
	String itinerary = "DDAG";
	String orientation = "N";
	GardenPosition position = new GardenPosition(0,0,orientation);
	int[] areaDimension = new int[] {10,10};
	Lawnmower lawnmower = new Lawnmower(position, itinerary, areaDimension);
	...
	@Test
	void lawnmowerInstanciation_WithNullArguments_ShouldThrowAnIllegalArgumentException() {
		assertThrows(IllegalArgumentException.class, () -> new Lawnmower(null, null, null));
	}
	
	@Test
	void lawnmowerInstanciation_ShouldSetLawnmowerFields() {
